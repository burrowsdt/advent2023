# Day 9 - Part 2 
# Almost entirely the same as part 1, differences are primarily
# in the loop at line 35
# 
# Very tempted to wrap both parts in a single function
# (or make a flexible function for final component of each part?) but just happy
# to have completed this day's work fairly quickly!!!
...
for (i in seq_along(input)){
  ...
  for (j in rev(seq_along(temp_list))){
    ...
    curr_row <- append(curr_row[1] - num_to_sub, curr_row)
    num_to_sub <- curr_row[1]
